...
public:
     ...
     */
    DBusObjectManagerProxy(sdbus::IConnection& connection,
    ...
    std::shared_ptr<IDBusDeviceProxy> createDevice(std::string objectPath) override {
        return std::make_shared<DBusDeviceProxy>(mConnection, mDestination, sdbus::ObjectPath{objectPath});
    }
    ...
    std::shared_ptr<IDBusCharacteristicProxy> createCharacteristic(std::string objectPath) override { 
        return std::make_shared<DBusCharacteristicProxy>(mConnection, mDestination, sdbus::ObjectPath{objectPath});
    }
